...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Laporan Penjualan Januari

    <!--<a class="btn btn-primary btn-social pull-right" href="modules/lap-penjualan/cetak.php" target="_blank">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * from penjualan_januari")
